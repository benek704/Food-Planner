...
<section class="dashboard-section">
    <div class="row dashboard-nowrap">
        <%@include file="/app/dashboard/dashboardSection.jsp" %>
            ...
            <div class="dashboard-content border-dashed p-3 m-4 view-height">
                <div class="row border-bottom border-3 p-1 m-1">
                    ...
                    <div class="col d-flex justify-content-end mb-2 noPadding">
                        <button type="submit" form="add-to-plan" class="btn btn-success rounded-0 pt-0 pb-0 pr-4 pl-4">Zapisz</button>
                    </div>
                </div>

                <div class="schedules-content">
                    <form id="add-to-plan" method="post">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" value="" name="mealName" id="name" placeholder="Nazwa posiłku">
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-2">
                                <input type="text" class="form-control" value="" name="mealNumber" id="number" placeholder="Numer posiłki">
                            </div>
                        </div>
                        <div class="form-group row">
